 ...
 */
export function filterFolkCare(options) {
 ...
 */
export function shouldShowFolkNotes(item, sensitiveGroups) {
    // Nếu item không có folk ingredients, hiển thị bình thường
    if (!item.hasFolkIngredients)
        return true;
 ...
 */
export function getSensitiveWarning() {
 ...
 */
export function getSafetyLevelLabel(level) {
    const labels = {
        safe: 'An toàn',
 ...
 */
export function formatFolkCareForDisplay(item, sensitiveGroups) {
    return {
        ...item,
